...
var QSUI = (function () {
    ...
    var CSS = [
        ...
        "border:1px solid var(--qs-edge,#ccd2dc);background:var(--qs-bg,#f6f7f9);color:var(--qs-ink,#14181f)}",
        ...
        "outline-offset:2px}",
        ".qs-dialog input[type=text]{font:inherit;padding:6px 9px;border:1px solid var(--qs-edge,#ccd2dc);color:var(--qs-ink,#14181f);background:var(--qs-face,#fff);",
        ...
        ".qs-menu button:hover{background:var(--qs-bg,#eef2f9)}",
        ...
        "border:1px solid var(--qs-edge,#ccc);background:var(--qs-bg,#f5f5f5);color:var(--qs-ink,#333);",
