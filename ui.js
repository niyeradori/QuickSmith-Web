...
var QSUI = (function () {
    ...
    var CSS = [
        ...
        "box-shadow:0 12px 48px -12px rgba(0,0,0,.45);color:var(--qs-ink,#14181f);background:var(--qs-face,#fff);",
        ...
        "color:var(--qs-text,#8b93a3);padding:0 2px}",
        ".qs-dialog-x:hover{color:var(--qs-ink,#14181f)}",
        ...
        "border:1px solid var(--qs-edge,#ccd2dc);background:var(--qs-sunk,#f6f7f9);color:var(--qs-ink,#14181f)}",
        ...
        "outline-offset:2px}",
        ".qs-dialog input[type=text]{font:inherit;padding:6px 9px;border:1px solid var(--qs-edge,#ccd2dc);color:var(--qs-ink,#14181f);background:var(--qs-card,#fff);",
        ...
        ".qs-menu{position:fixed;z-index:2000;background:var(--qs-face,#fff);border:1px solid var(--qs-rim,#d9dee7);",
        ...
        "font:inherit;padding:7px 12px;border-radius:5px;cursor:pointer;color:var(--qs-ink,#14181f)}",
        ".qs-menu button:hover{background:var(--qs-sunk,#eef2f9)}",
        ".qs-menu button[disabled]{color:var(--qs-text,#a8afbb);cursor:default;background:none}",
        ...
        "border:1px solid var(--qs-edge,#ccc);background:var(--qs-sunk,#f5f5f5);color:var(--qs-ink,#333);",
        ...
        ".qs-spin>button:hover{background:var(--qs-rim,#e6e6e6)}",
        ".qs-spin>button:active{background:var(--qs-rim,#d4d4d4);filter:brightness(.92)}",
        ".qs-spin>button:focus-visible{outline:2px solid var(--qs-vswr,#1f5fbf);outline-offset:-2px}"
    ].join("");
