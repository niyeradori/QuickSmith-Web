...
var QSUI = (function () {
    ...
    var CSS = [
        ...
        "outline-offset:2px}",
        ".qs-dialog input[type=text]{font:inherit;padding:6px 9px;border:1px solid var(--qs-rim,#ccd2dc);color:var(--qs-ink,#14181f);background:var(--qs-face,#fff);",
        ...
        "border:1px solid var(--qs-rim,#ccc);background:var(--qs-bg,#f5f5f5);color:var(--qs-ink,#333);",
